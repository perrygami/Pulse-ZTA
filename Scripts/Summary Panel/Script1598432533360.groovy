...
print((new_g[0]) + (new_g[1]))

//WebUI.verifyEqual(Gateway_value, g[0])

//WebUI.verifyEqual(Gateway_totalvalue, new_g[0])
...
UI_users = WebUI.getText(findTestObject('Summary Panel/Devices'))
...
UI_devices = WebUI.getText(findTestObject('Summary Panel/Applications'))
...
UI_Applications = WebUI.getText(findTestObject('Summary Panel/Non-complaince'))
...
UI_non_compliance = WebUI.getText(findTestObject('Summary Panel/Anomalies'))
...
UI_anomalies = WebUI.getText(findTestObject('Summary Panel/Users'))
